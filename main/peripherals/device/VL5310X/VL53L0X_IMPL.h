#ifndef VL53L0X_IMPL_h
#define VL53L0X_IMPL_h
...
private:
    ...
    uint8_t stop_variable; // read by init and used when starting measurement; is StopVariable field of VL53L0X_IMPL_DevData_t structure in API
