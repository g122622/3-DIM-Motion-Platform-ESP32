...
static const struct ble_gatt_svc_def gatt_svr_svcs[] = {
    ...
    },
    {
        ...
        .characteristics = (struct ble_gatt_chr_def[]){
            ...
            {
                .uuid = &gatt_remoteControll_chr_system_status_uuid.u,
                .access_cb = gatt_remoteControll_svc_access,
                .flags = BLE_GATT_CHR_F_READ | BLE_GATT_CHR_F_WRITE | BLE_GATT_CHR_F_NOTIFY | BLE_GATT_CHR_F_WRITE_NO_RSP,
                .val_handle = &gatt_remoteControll_chr_system_status_val_handle,
            },
            {
                .uuid = &gatt_remoteControll_chr_task_batch_uuid.u,
                .access_cb = gatt_remoteControll_svc_access,
                .flags = BLE_GATT_CHR_F_READ | BLE_GATT_CHR_F_WRITE | BLE_GATT_CHR_F_NOTIFY | BLE_GATT_CHR_F_WRITE_NO_RSP,
                .val_handle = &gatt_remoteControll_chr_task_batch_val_handle,
            },
            {
                .uuid = &gatt_remoteControll_chr_pen_uuid.u,
                .access_cb = gatt_remoteControll_svc_access,
                .flags = BLE_GATT_CHR_F_READ | BLE_GATT_CHR_F_WRITE | BLE_GATT_CHR_F_NOTIFY | BLE_GATT_CHR_F_WRITE_NO_RSP,
                .val_handle = &gatt_remoteControll_chr_pen_val_handle,
            },
            {
                0, /* No more characteristics in this service. */
            }},
    },
    {
        ...
        .characteristics = (struct ble_gatt_chr_def[]){
            ...
            {
                .uuid = &gatt_remoteInfo_chr_realtime_pos_uuid.u,
                .access_cb = gatt_remoteInfo_svc_access,
                .flags = BLE_GATT_CHR_F_READ,
                .val_handle = &gatt_remoteInfo_chr_realtime_pos_val_handle,
            },
            {
                .uuid = &gatt_remoteInfo_chr_power_voltage_uuid.u,
                .access_cb = gatt_remoteInfo_svc_access,
                .flags = BLE_GATT_CHR_F_READ,
                .val_handle = &gatt_remoteInfo_chr_power_voltage_val_handle,
            },
            {
                .uuid = &gatt_remoteInfo_chr_cmd_number_uuid.u,
                .access_cb = gatt_remoteInfo_svc_access,
                .flags = BLE_GATT_CHR_F_READ,
                .val_handle = &gatt_remoteInfo_chr_cmd_number_val_handle,
            },
            {
                0, /* No more characteristics in this service. */
            }},
